...
const MyContributionsPage = () => {
    ...
    const processedContributions = useMemo(() => {
        ...
        let contributions = mockContributionsData.filter(c => c.memberName === userFullName);
    ...
    }, [activeTab, searchQuery, sortConfig, user]);
    ...
    const handleDownloadPDF = () => {
        const doc = new jsPDF();
        const tableColumn = ["Contribution ID", "Date", "Group Name", "Amount", "Type", "Contribution Type", "Status"];
        ...
        const reportTitle = `My Contributions Report`;
        const fileName = `My_Contributions_Report.pdf`;
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-500 mt-1">A detailed history of all your contributions across all your savings groups.</p>
            </div>
                ...
                <div className="overflow-x-auto">
                    ...
                    {processedContributions.length === 0 && (
                        <div className="text-center py-10 text-gray-500">
                            <p>You have no contributions to display.</p>
                        </div>
                    )}
                </div>
